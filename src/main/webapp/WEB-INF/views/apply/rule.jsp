        ...
        <div id="container">
            ...
            <div id="content">
                ...
                <div class="contentIn">
                	...
                	<h4>제3조 (참가비 및 부스)</h4>
                	<ul>
                		<li class="explanation">참가비는 A타입 부스는 1,000,000원/부스이며(VAT별도), B타입 부스는 2,000,000원/부스이며(VAT별도), "주관자"에 의해 할인율을 적용할 수 있다.</li>
                		<li class="explanation">"참가자"는 참가신청서를 "주관자"에게 제출하고, "주관자"로부터 참가비 입금일을 기준으로 참가신청이 성립된 것으로 간주한다.</li>
                	</ul>
                	</div>
                	...
                	<h4>제4조 (전시장 사용기간)</h4>
                	<ul>
                		<li class="explanation">전시장 사용기간은 2021.10.28.(목) ~ 2021. 10. 30(토) [3일간]으로 하며, 전시준비 및 철거에 필요한 시간을 별도로 추가하여 제공할 수 있다.</li>
                	...
                	<h4>제9조 (전시회 변경)</h4>
                	<ul>
                		<li class="explanation">"주관자"가 전시회 개최를 취소하는 경우 이미 납부한 참가비 전액을 "참가자"에게 반환한다.</li>
                	...
                	<h4>제10조 (보충규정)</h4>
                	<ul>
                		<li class="explanation">단, "주관자"가 국가 위기 상황이나 천재지변 등 불가항력적인 사정으로 개최일 및 장소를 변경하거나 축소 또는 취소하는 경우 참가신청과 관련된 보상을 청구할 수 없다.</li>
                	</ul>
                	</div>
