...
<html lang="ko">
    <head>
        ...
        <title>/anony/retrieve.jsp</title>
    ...
    <body>
        <h1>WEB-INF/views/anony/retrieve.jsp</h1>
            ...
            <form action="/anony/retrieve" method="POST" id="Reg">
                <div id="getPage">
                    <div class="contentLine">
                        ...
                        <p>&nbsp;</p>
                        <div><textarea name="content" id="" cols="30" rows="10" placeholder="내용을 입력해 주세요" required></textarea></div>
                        <p>&nbsp;</p>
